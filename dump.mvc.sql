...
--
-- Table structure for table `test_bee_status`
--

DROP TABLE IF EXISTS `test_bee_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `test_bee_status` (
...
--
-- Dumping data for table `test_bee_status`
--

LOCK TABLES `test_bee_status` WRITE;
/*!40000 ALTER TABLE `test_bee_status` DISABLE KEYS */;
INSERT INTO `test_bee_status` VALUES (2,'В процессе'),(3,'Выполнено'),(4,'Отклонено'),(1,'Открыто');
/*!40000 ALTER TABLE `test_bee_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `test_bee_user`
--

DROP TABLE IF EXISTS `test_bee_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `test_bee_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `status_id` int(10) NOT NULL DEFAULT '1',
  `name` varchar(255) DEFAULT NULL COMMENT 'product name',
  `email` varchar(255) DEFAULT NULL,
  `create_work` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `work` text,
  `editWork` tinyint(1) NOT NULL DEFAULT '0',
  `result` varchar(255) DEFAULT '',
  `finish_status` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `test_bee_user`
--

LOCK TABLES `test_bee_user` WRITE;
/*!40000 ALTER TABLE `test_bee_user` DISABLE KEYS */;
INSERT INTO `test_bee_user` VALUES (1,2,'Александр','gs.babaev_protected@yandex.ru','2019-12-24 11:57:10','Bee see',0,'','0000-00-00 00:00:00'),(2,1,'qw','gs.babaev@yandex.ru','2019-12-24 13:07:13','qw908',1,'0','2019-12-24 21:46:45'),(3,4,'qw1','gs.babaev@yandex.ru','2019-12-24 13:20:59','qw',0,'88','2019-12-24 21:44:10'),(4,1,'sdcdcalert(‘test’);','gs.babaev@yandex.ru','2019-12-24 13:32:54','sdvsddcalert(‘test’)',1,'','2019-12-24 21:48:42'),(6,3,'sxdc','gs.babaev@yandex.ru','2019-12-24 14:57:45','dcdc',1,'','0000-00-00 00:00:00'),(7,1,'Александр1','gs.babaev_protected@yandex.ru','2019-12-24 16:54:45','Bee see',0,'','0000-00-00 00:00:00'),(8,4,'mxc','mndv@dvvfd.ru','2019-12-24 17:05:55','dfvd',1,'','2019-12-24 21:36:48');
/*!40000 ALTER TABLE `test_bee_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-24 22:02:18
